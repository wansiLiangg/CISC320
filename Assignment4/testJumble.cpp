...
void testJumble() {
	...
	cout << "Hidden word has less than 3 alphabets" << endl;
	try {
		JumblePuzzle jp5("qq", "easy");
	} catch(BadJumbleException &e) {
		cout << e.what() << endl << endl;
	}

	cout << "Hidden word has more than 10 alphabets" << endl;
	try {
		JumblePuzzle jp6("abcdefghijklmn", "easy");
	} catch(BadJumbleException &e) {
		cout << e.what() << endl << endl;
	}
	...
	try {
		JumblePuzzle jp7("HELLO", "beginner");
	} catch(BadJumbleException &e) {
		cout << e.what() << endl << endl;
	}

	//Test GET classes, should returns a single integer or alphabet
	JumblePuzzle test("HELLO", "medium");
	showJumble(test.getJumble(), test.getSize());

	cout << "Size (should be 5*3=15): " << endl;
	cout << test.getSize() << endl << endl;

	cout << "Col: " << endl;
	cout << test.getColPos() << endl << endl;

	cout << "Row: " << endl;
	cout << test.getRowPos() << endl << endl;

	cout << "Difficulty level: " << endl;
	cout << test.getDifficulty() << endl << endl;

	cout << "Direction: " << endl;
	cout << test.getDirection() << endl << endl;
